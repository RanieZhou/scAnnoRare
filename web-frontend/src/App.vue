      ...
      <aside class="sidebar glass-effect">
        ...
        <nav class="nav-menu">
          ...
          <router-link to="/agent" class="nav-item">
            <el-icon><Cpu /></el-icon>
            <span>计算节点配对</span>
            <span v-if="agentStore.isOnline" class="badge dot-online"></span>
            <span v-else class="badge dot-offline"></span>
          </router-link>
      ...
      <div class="main-container">
        ...
        <header class="topbar glass-effect">
          ...
          <div class="header-right">
            <!-- Central project indicator -->
            <div class="current-project">
              <el-icon><Briefcase /></el-icon>
              <span>项目：单细胞稀有评估 MVP</span>
            </div>
            
            <!-- Local Agent Connection status badge -->
            <el-tag :type="agentStore.isOnline ? 'success' : 'danger'" class="agent-badge" effect="dark">
...
// Periodically check local agent health (every 3 seconds)
let intervalId: any = null

onMounted(async () => {
  await agentStore.checkAgentHealth()
  if (agentStore.isOnline) {
...
<style>
/* CSS Reset and Curated Theme variables */
:root {
  --bg-color: #080a0e;
...
/* Customize Element Plus dark style locally */
